...
def upgrade() -> None:
    op.alter_column('posts','owner_id',type_=sa.String(), postgresql_using = 'owner_id::character varying')


def downgrade() -> None:
    op.alter_column('posts','owner_id',type_=sa.Integer(), postgresql_using = 'owner_id::integer')
