...
class WebScraper(BaseScraper):
    ...
    def create_posts_from_html(self, soup):
        ...
        for el in scraped_info:
            ...
            post = NewPost(
                title=f"{title} {price}", body=description, owner_id=self.user_id,is_autogenerated=True
            )
            self.add_post(post)
...
class ToScrape(BaseScraper):
    ...
    def create_post_from_book_on_page(self, url):
        ...
        if title_element and body_element:
            ...
            post = NewPost(title=title, body=body, owner_id=self.user_id,is_autogenerated=True)
            return post
