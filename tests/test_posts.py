...
def test_create_post():
  res = client.post('/posts',headers=get_auth_header(),json={'title':"Test","body":"Test","owner_id":str(get_test_user_id())})
...
def test_change_post():
  res = client.put(f'/posts/{get_test_post_id()}',headers=get_auth_header(),json={'title':"Test1","body":"Test1"})
